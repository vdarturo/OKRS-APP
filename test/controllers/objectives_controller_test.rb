...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference("Objective.count") do
      post objectives_url, params: { objective: { average_progress: @objective.average_progress, description: @objective.description, name: @objective.name, organization_id: @objective.organization_id, owner_id: @objective.owner_id } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { average_progress: @objective.average_progress, description: @objective.description, name: @objective.name, organization_id: @objective.organization_id, owner_id: @objective.owner_id } }
